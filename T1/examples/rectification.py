...
circuit.X('D1', 'BAS21QC', 'in', 'output_plus')
circuit.R('load', 'output_plus', 'output_minus', 100@u_Ω)
circuit.X('D2', 'BAS21QC', 'output_minus', circuit.gnd)
circuit.X('D3', 'BAS21QC', circuit.gnd, 'output_plus')
circuit.X('D4', 'BAS21QC', 'output_minus', 'in')
...
circuit.X('D1', 'BAS21QC', 'in', 'output_plus')
circuit.X('D3', 'BAS21QC', node_230, 'output_plus')
circuit.X('D2', 'BAS21QC', 'output_minus', node_230)
circuit.X('D4', 'BAS21QC', 'output_minus', 'in')
