...
circuit.include(spice_library['BAS21QC_RT'])
# Fixme: Xyce: Device model BAS21QC_RT: Illegal parameter(s) given for level 1 diode: IKF
source = circuit.V('input', 'in', circuit.gnd, dc_offset)
circuit.R(1, 'in', 'out', 1@u_kΩ)
circuit.D('1', 'out', circuit.gnd, model='BAS21QC_RT')
